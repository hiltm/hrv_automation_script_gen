...
## incubation ##
incubationTestCycles_min = 0
incubationTestCycles_max = 50
incubationTestCycles_dft = 10
incubationTestIncubatorDrawVolume_min = 0 #mL
incubationTestIncubatorDrawVolume_max = 2000 #mL
incubationTestIncubatorDrawVolume_max = 1000 #mL
incubationTestInjectorDrawVolume_min = 0 #mL
incubationTestInjectorDrawVolume_max = 2000 #mL
incubationTestInjectorDrawVolume_dft = 0 #mL
incubationTestWaitBetweenPorts_min = 0 #sec
incubationTestWaitBetweenPorts_max = 300 #sec
incubationTestWaitBetweenPorts_dft = 10 #sec
incubationTestWaitBetweenStudies_min = 0 #sec
incubationTestWaitBetweenStudies_max = 200000 #sec
incubationTestWaitBetweenStudies_max = 100 #sec